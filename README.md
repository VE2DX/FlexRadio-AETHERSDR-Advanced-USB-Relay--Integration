...
- A better SO2R integration, where two remote antenna switching boxes or an SO2R remote antenna box can be managed TOGETHER to prevent radio damage from improper antenna selection.
